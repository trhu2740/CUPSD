...
try: # Try block tests to ensure a command line argument is given
    arg1 = sys.argv[1] # If there's a command line argument (actuator position), set arg1 to it
    print(arg1)
...
actuator.changePosition(int(arg1)) # Move the linear actuator to the desired position (command line input)